...
import co.topl.daml.base.SignedAssetTransferRequestProcessorBaseTest
...
class SignedAssetTransferRequestProcessorTest extends CatsEffectSuite with SignedAssetTransferRequestProcessorBaseTest {
